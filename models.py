...
# - start actual project 4 code - session related stuff
class Session(ndb.Model):
    ...
    startTime       = ndb.IntegerProperty() # 1900 = 7 PM
    nonWSBefore7    = ndb.ComputedProperty(lambda self: self.typeOfSession != "workshop" and self.startTime < 1900)

class SessionForm(messages.Message):
    """SessionForm -- Session outbound form message"""
    conferenceId    = messages.IntegerField(1)
    organizerUserId = messages.StringField(2)
